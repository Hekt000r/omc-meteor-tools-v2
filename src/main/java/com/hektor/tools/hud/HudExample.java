...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(OMCTools.HUD_GROUP, "example", "HUD element example.", HudExample::new);
